...
def _resolve_profile(profile_key=None, profile=None):
    if profile is not None:
        return profile
    return get_market_profile(profile_key or default_market_profile_key())


def _current_market_window(profile_key=None, profile=None):
    profile = _resolve_profile(profile_key=profile_key, profile=profile)
...
def _resolve_market_by_start_time(start_time_utc, profile_key=None, profile=None):
    profile = _resolve_profile(profile_key=profile_key, profile=profile)
...
def _resolve_current_market(profile_key=None, profile=None):
    profile = _resolve_profile(profile_key=profile_key, profile=profile)
    start_time_utc, _ = _current_market_window(profile=profile)
